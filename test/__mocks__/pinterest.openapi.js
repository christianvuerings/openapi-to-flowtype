...
export type PinCustom = {|
  ...
  additional_hide_reasons? : Enum_RecommendationComplaintReason[],
  alt_text? : ?string,
  ...
  created_at? : ?string,
  creative_types? : ?Enum_CreativeTypes[],
  creator_analytics? : ?{| [key : string] : mixed |},
  cta_text? : ?string,
  dark_profile_link? : string,
  deb_ads? : string[],
  deb_all_signals? : string[],
  deb_content_quality? : string[],
  deb_inclusive_product? : string[],
  deb_shopping? : string[],
  deb_trust_and_safety? : string[],
  ...
  domain? : string,
  domain_tracking_params? : SubModel_DomainTrackingFormat[],
  ...
  gallery? : ( GalleryItemCustom | GalleryItemDetailed | GalleryItemSummary )[],
  ...
  rich_recipe_top_ingredients? : SubModel_TopIngredient[],
  root_pin_id? : string,
...
export type SubModel_ClickThroughLinkQuality = {|
  alternate_links? : SubModel_AltLink[],
...
export type SubModel_FeedbackOptionsWithRecommendationReason = {|
  menu_options? : | FeedbackOptionsCustom
...
export type UserCustom = {|
  ...
  community_roles? : Enum_CommunityRole[],
  ...
  eligible_profile_tabs? : ( ProfileTabCustom | ProfileTabDetailed | ProfileTabSummary )[],
  email? : ?string,
